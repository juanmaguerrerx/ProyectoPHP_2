        ...
        <form method="POST" action="{{ route('clientes.store') }}">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control blu" id="cif" name="cif" value="{{ old('cif') }}">
                    @error('cif')
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="cuenta_corriente" name="cuenta_corriente" value="{{ old('cuenta_corriente') }}">
                ...
                <div class="col-md-6">
                    ...
                    <select name="pais" id="pais" class="form-control" value="{{ old('pais') }}">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select name="moneda" disabled class="form-control sel" id="moneda" value="{{ old('moneda') }}">
                        <option value="" default>-Moneda-</option>
                        @foreach ($paises as $pais)
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="importe_mensual" id="importe_mensual" value="{{ old('importe_mensual') }}">
